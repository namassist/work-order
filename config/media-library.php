...
use App\Support\Attachments\AttachmentPathGenerator;
...
return [
     ...
     */
    'max_file_size' => 1024 * 1024 * (int) env('MEDIA_MAX_FILE_SIZE_MB', 50),
     ...
     */
    'path_generator' => AttachmentPathGenerator::class,
