...
- **PROVISIONAL: initial `view-all` grants.** `RolePermissionSeeder::INITIAL_ROLES` gives `work-orders.view-all` to `approver` and `keuangan` (fresh installs only; admins edit roles afterwards).
